...
namespace PetHaven.Data.Migrations
{
    ...
    [Migration("20250330085704_Update_Tables_ForumThread_ForumComment")]
    partial class Update_Tables_ForumThread_ForumComment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetHaven.Data.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "David",
                            LastName = "Olaniran",
                            PasswordHash = "AQAAAAEAACcQAAAAEEcittd3ibeAypM3p3nzJ6y61NRPG+Yls1wMEBy1iwOOYjGkSX4dmomH6ee6dh/JUw==",
                            Role = "Administrator",
                            ZipCode = "10027"
                        });
                });
